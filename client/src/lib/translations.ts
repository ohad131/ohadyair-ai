...
export const translations = {
  he: {
    ...
    // BuzzAI Section
    buzzaiTitle: "BuzzAI – הקהילה שחיה ונושמת AI",
    buzzaiSubtitle: "מרחב עדכני שבו כל אחד יכול להבין, לשאול ולהישאר מחובר לעולם הבינה המלאכותית.",
    buzzaiDescription:
      "רוצים להבין באמת מה קורה בעולם הבינה המלאכותית? BuzzAI מאחדת אנשים סקרנים סביב חדשות, שיחות פתוחות והשראה לפרויקטים חדשים – בשפה פשוטה וברוח קהילתית.",
    buzzaiCtaPrimary: "הצטרפו לערוץ העדכונים",
    buzzaiCtaSecondary: "עברו לקבוצת הדיונים",
    buzzaiFeature1Title: "חדשות ועדכונים חיים",
    buzzaiFeature1Desc: "סיכומים יומיים וניתוחים קלים להבנה של המגמות, הכלים וההשקות החשובות ביותר בעולם ה-AI.",
    buzzaiFeature2Title: "קהילה סקרנית ומעורבת",
    buzzaiFeature2Desc: "שיחות פתוחות עם אנשים שחיים טכנולוגיה, משתפים תובנות ושואלים את כל השאלות שבאמת מסקרנות.",
    buzzaiFeature3Title: "השראה לרעיונות ופרויקטים",
    buzzaiFeature3Desc: "קבלו רעיונות לשימושים חדשים, פרויקטים ייחודיים ודרכים לחשוב מחוץ לקופסה בעולמות הבינה המלאכותית.",
    buzzaiMetric1Value: "100%",
    buzzaiMetric1Label: "תוכן ידידותי וברור",
    buzzaiMetric2Value: "24/7",
    buzzaiMetric2Label: "קהילה פעילה ומזמינה",
    buzzaiMetric3Value: "2",
    buzzaiMetric3Label: "ערוצי טלגרם להצטרפות מידית",
  ...
  en: {
    ...
    // BuzzAI Section
    buzzaiTitle: "BuzzAI – The community that breathes AI",
    buzzaiSubtitle: "A living hub where anyone can follow, learn, and talk about the fast-moving world of artificial intelligence.",
    buzzaiDescription:
      "Want to truly understand what's happening in AI? BuzzAI brings curious people together for news, open conversations, and inspiration for your next idea – all in plain language.",
    buzzaiCtaPrimary: "Join the updates channel",
    buzzaiCtaSecondary: "Enter the discussion group",
    buzzaiFeature1Title: "Live news & updates",
    buzzaiFeature1Desc: "Daily rundowns and easy-to-digest analysis of the biggest AI launches, tools, and trends.",
    buzzaiFeature2Title: "Curious, engaged community",
    buzzaiFeature2Desc: "Open conversations with people who live technology, share insights, and ask the questions you're thinking about.",
    buzzaiFeature3Title: "Inspiration for ideas & projects",
    buzzaiFeature3Desc: "Get sparks for new use cases, standout projects, and creative thinking across the AI landscape.",
    buzzaiMetric1Value: "100%",
    buzzaiMetric1Label: "Clear, friendly explanations",
    buzzaiMetric2Value: "24/7",
    buzzaiMetric2Label: "Active, welcoming community",
    buzzaiMetric3Value: "2",
    buzzaiMetric3Label: "Telegram channels to join right now",
