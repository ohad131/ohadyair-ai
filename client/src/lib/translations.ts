export const translations = {
  he: {
    ...
    servicesSubtitle: "פתרונות מותאמים אישית משלבים AI, אוטומציה וטכנולוגיות מתקדמות",
    service1Title: "AI לעסקים",
    service1Desc: "שילוב מודלי שפה, אסיסטנטים חכמים, וכלי AI ואוטומציה לצרכים עסקיים",
    service2Title: "אתרים",
    service2Desc: "פיתוח אתרים מתקדמים, מהירים ומותאמים SEO עם טכנולוגיות מודרניות",
    service3Title: "אוטומציות",
    service3Desc: "מתמחה בשילוב הכלים המתקדמים ביותר כמו n8n, חיבור, טיפול ועיבוד נתונים",
    service4Title: "ייעוץ",
    service4Desc: "ליווי והדרכה בשילוב AI בעסק, תכנון אסטרטגי ופתרון אתגרים טכנולוגיים",
    service5Title: "פתרונות מותאמים",
    service5Desc: "פיתוח כלים ייעודיים, אפליקציות ומערכות בהתאמה מלאה לצרכי הלקוח",
    service6Title: "תמיכה",
    service6Desc: "תמיכה טכנית מקצועית, תחזוקה שוטפת ועדכונים למערכות קיימות",
