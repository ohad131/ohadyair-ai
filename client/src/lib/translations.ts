...
export const translations = {
  he: {
    ...
    service3Desc: "בניית זרימות עבודה אוטומטיות עם n8n/Activepieces, חיבור API, וסקרייפינג מתקדם",
    service4Title: "הרצאות והכשרות",
    service4Desc: "הרצאות מעוררות השראה והכשרות מעשיות ב-AI, אוטומציה וטכנולוגיות מתקדמות",
    service5Title: "יזמות",
    ...
    chatPlaceholder: "איך תרצה שנשתמש ב-AI בעסק שלך?",
    chatSend: "שליחה",
    chatThinking: "חושב על רעיונות עבורך...",
    chatError: "לא הצלחתי לענות. נסה שוב בעוד רגע.",
    chatSuggestionsTitle: "נושאים פופולריים",
    ...
    // BuzzAI Section
    buzzaiTitle: "BuzzAI – הקהילה שחיה ונושמת בינה מלאכותית",
    buzzaiSubtitle:
      "רוצים להבין באמת מה קורה בעולם הבינה המלאכותית? ברוכים הבאים ל-BuzzAI – קהילה חיה ונושמת של אנשים שחיים טכנולוגיה, חדשנות ובינה מלאכותית.",
    buzzaiHighlightsLead: "כאן תקבלו את כל מה שבאז בעולם הבינה המלאכותית:",
    buzzaiDescription:
    ...
    buzzaiFooter: "בואו להיות חלק מהקהילה שמביאה את ה-AI לשפה של כולנו.",
    buzzaiCtaPrimary: "הצטרפו לערוץ העדכונים",
    buzzaiCtaPrimaryTitle: "ערוץ הטלגרם של BuzzAI",
    buzzaiCtaPrimaryDesc: "הישארו מעודכנים עם חדשות, כלים ודגשים חמים לפני כולם.",
    buzzaiCtaSecondary: "עברו לקבוצת הדיונים",
    buzzaiCtaSecondaryTitle: "קבוצת השיח החיה",
    buzzaiCtaSecondaryDesc: "כשהגיע הזמן לדבר על הכל יחד – זה המקום לשאלות, רעיונות וחיבורים.",
    buzzaiFeature1Title: "חדשות ועדכונים חשובים מהעולם",
    buzzaiFeature1Desc: "קבלו בכל יום את מה שבאמת בוער ב-AI – סיכומי חדשות, מגמות והשקות מדויקות.",
    buzzaiFeature2Title: "הסברים פשוטים על מושגים",
    buzzaiFeature2Desc: "פירוקים ברורים למונחים, מגמות וכלים חדשים – בשפה שכל אחד מבין.",
    buzzaiFeature3Title: "שיחות פתוחות וסקרנות משותפת",
    buzzaiFeature3Desc: "קהילה שמדברת בגובה העיניים, משתפת תובנות ושואלת את כל מה שמעניין.",
    buzzaiFeature4Title: "השראה לרעיונות ולפרויקטים",
    buzzaiFeature4Desc: "הציתו את היצירתיות עם סיפורים, טמפלטים ורעיונות ליישומי AI מחוץ לקופסה.",
    buzzaiMetric1Value: "24/7",
    buzzaiMetric1Label: "תוכן וחיבורים שמתעדכנים מסביב לשעון",
    buzzaiMetric2Value: "4",
    buzzaiMetric2Label: "תחומי תוכן מרכזיים – חדשות, הסברים, שיחות והשראה",
    buzzaiMetric3Value: "2",
    buzzaiMetric3Label: "ערוצי טלגרם זמינים להצטרפות מידית",
  ...
  en: {
    ...
    chatPlaceholder: "How can we apply AI in your business?",
    chatSend: "Send",
    chatThinking: "Thinking through an answer…",
    chatError: "I couldn't generate a reply. Try again in a moment.",
    chatSuggestionsTitle: "Popular prompts",
    ...
    // BuzzAI Section
    buzzaiTitle: "BuzzAI – The community that lives and breathes AI",
    buzzaiSubtitle:
      "Want to truly understand what's happening in AI? Welcome to BuzzAI—a vibrant community of people who live technology, innovation, and artificial intelligence.",
    buzzaiHighlightsLead: "Here’s everything buzzing in the AI world:",
    buzzaiDescription:
      "BuzzAI was built to be a space where anyone can understand, share, ask questions, and stay current. You don’t need to be a developer or researcher—curiosity is enough.",
    buzzaiFooter: "Join the community that makes AI part of everyone’s language.",
    buzzaiCtaPrimary: "Join the updates channel",
    buzzaiCtaPrimaryTitle: "The BuzzAI Telegram channel",
    buzzaiCtaPrimaryDesc: "Stay ahead with daily highlights, tool drops, and curated AI signals.",
    buzzaiCtaSecondary: "Enter the discussion group",
    buzzaiCtaSecondaryTitle: "Our collaborative chat",
    buzzaiCtaSecondaryDesc: "When you're ready to talk it out together, dive into the live discussions.",
    buzzaiFeature1Title: "Essential news & updates",
    buzzaiFeature1Desc: "Get the daily buzz on launches, trends, and breakthroughs that actually matter.",
    buzzaiFeature2Title: "Plain-language explainers",
    buzzaiFeature2Desc: "Break down concepts, trends, and new tools in a way that everyone can follow.",
    buzzaiFeature3Title: "Open conversations",
    buzzaiFeature3Desc: "Connect with curious minds, swap insights, and ask the questions no one else is asking.",
    buzzaiFeature4Title: "Inspiration for ideas & projects",
    buzzaiFeature4Desc: "Spark new experiments with stories, templates, and real-world ways to use AI creatively.",
    buzzaiMetric1Value: "24/7",
    buzzaiMetric1Label: "Fresh insights and community energy, around the clock",
    buzzaiMetric2Value: "4",
    buzzaiMetric2Label: "Core themes: news, explainers, conversations, inspiration",
    buzzaiMetric3Value: "2",
    buzzaiMetric3Label: "Telegram spaces ready for you to join instantly",
...
export function useTranslation() {
  ...
  const t = (key: keyof typeof translations.he) => {
...
export function getTranslation(lang: Language, key: keyof typeof translations.he) {
