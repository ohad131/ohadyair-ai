...
const SITE_CONTENT_SECTIONS: SiteContentSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "buzzaiHighlightsLead", label: "BuzzAI Highlights Lead", type: "textarea" },
      { key: "buzzaiDescription", label: "BuzzAI Description", type: "textarea" },
      { key: "buzzaiFooter", label: "BuzzAI Footer", type: "textarea" },
      { key: "buzzaiCtaPrimary", label: "Primary CTA Label" },
      { key: "buzzaiCtaPrimaryTitle", label: "Primary CTA Title" },
      { key: "buzzaiCtaPrimaryDesc", label: "Primary CTA Description", type: "textarea" },
      { key: "buzzaiCtaSecondary", label: "Secondary CTA Label" },
      { key: "buzzaiCtaSecondaryTitle", label: "Secondary CTA Title" },
      { key: "buzzaiCtaSecondaryDesc", label: "Secondary CTA Description", type: "textarea" },
      ...
      { key: "buzzaiFeature4Title", label: "Feature 4 Title" },
      { key: "buzzaiFeature4Desc", label: "Feature 4 Description", type: "textarea" },
