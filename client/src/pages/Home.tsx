...
export default function Home() {
  ...
  const fallbackProjects = isHebrew
    ? [
        ...
        {
          title: "צ'אט AI",
          description: "כפתור חדש לצ'אט AI שמאפשר לקבל תשובות ורעיונות בינה מלאכותית במהירות",
          tags: ["AI", "ייעוץ"],
          icon: "💬",
        },
      ]
    : [
        ...
        {
          title: "AI Chat",
          description: "A lightweight AI chat button that delivers quick insights and next steps",
          tags: ["AI", "Support"],
          icon: "💬",
        },
      ];
